...
```
Here is the formatted code snippet ready to copy and paste directly into your README.md file. I have formatted the code blocks, directory tree, and lists using proper Markdown syntax.
